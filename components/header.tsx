...
function Header() {
  ...
  const { data, error } = useMovies(
    `${process.env.tmdb_search_url}?api_key=${process.env.tmdb_api_key}&query=wonka`
  );
  ...
  return (
    <header>
      <div className="md:relative lg:relative absolute z-50 top-0 w-full  px-6 py-8">
        <div className="container mx-auto lg:px-26 flex items-center justify-between">
